...
echo "<script>alert('Error occurred and file  cannot be uploaded.Please use another picture.')
  location='add.php';
</script>";
echo mysqli_error($con);
...
$sel5="SELECT*FROM studentsignup WHERE username='$user'";
$sel52=mysqli_query($con,$sel5);
$row4=mysqli_fetch_assoc($sel52);
...
<form  method="post" style="height: 300px; border-top:5px solid #234; margin-top: 100px;border-radius: 10px;"  enctype="multipart/form-data" >
	<center><b>Update Student info <br><h1 style="color:black">Student's Username: <?php echo $user;?></h1></b></center>
	
<div class="form-group">
<input type="text" class="form-control" placeholder="Admission Year" required="required"  name='ady' value="<?php echo $row4['admission']?>"><br>	
<input type="text" class="form-control" placeholder="Graduation Year" required="required"  name="gy" value="<?php echo $row4['graduation'];?>"><br>
<input type="text" class="form-control" placeholder="CGPA" required="required"  name="cgpa"
value="<?php echo $row4['cgpa'];?>">
</div>
<?php echo "<img src='/dun/upload/".$row4["pat"]."' height='200' width='200'>";?>
<input id="filefield" type="file" name="filefield" class="form-control" required="required" 
  value="<?php  echo "<img src='/dun/upload/".$row4["pat"]."' height='200' width='200'>"; ?>" /><br>
<input id="filefield" type="text" name="dpt" class="form-control mt-2" required="required" placeholder="Department" value="<?php  echo $row4['dpt']; ?>" />
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">100 Level first semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">100 Level second semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">200 Level first semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">200 Level Second semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">300 Level first semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">300 Second  semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">400 First  semester courses</h5></div>
...
<div><h5 style="color:white;background-color: #0e7fef; text-align: center;">400 Second  semester courses</h5></div>
...
<button type="submit" class="btn btn-lg btn-primary ddd" name="upload">Submit</button>  
